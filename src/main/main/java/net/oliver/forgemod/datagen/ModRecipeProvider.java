...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.KOHLRABI_SEEDS.get(),1)
                .requires(ModItems.KOHLRABI.get(), 1)
                .unlockedBy(getHasName(ModItems.KOHLRABI.get()), has(ModItems.KOHLRABI.get())).save(pRecipeOutput);
